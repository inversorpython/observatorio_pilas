...
def stats_precios_medios_altas_bajas(df):
    ...
    media_altas = df[df['Id'].isin(id_altas)]["Precio"].median()
    print(media_altas)
    m2_media_altas = round(media_altas / df[df['Id'].isin(id_altas)]["M2"].median(), 2)
    print("M2 ", m2_media_altas)
    media_bajas = df[df['Id'].isin(id_bajas)]["Precio"].median()
    print(media_bajas)
    m2_media_bajas = round(media_bajas / df[df['Id'].isin(id_bajas)]["M2"].median(), 2)
    print("M2 ", m2_media_bajas)
    media_altas_bajas = df[df['Id'].isin(id_altas_bajas)]["Precio"].median()
